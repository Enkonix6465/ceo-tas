...
export default function EmployeePerformancePage() {
      ...
      <p className="font-bold text-gray-900 dark:text-gray-100">
        ...
        100%
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
                <div className="h-full" onClick={() => handleCardClick("all")}>
                  <StatCard
                ...
                <div className="h-full" onClick={() => handleCardClick("completed")}>
                  <StatCard
                ...
                <div className="h-full" onClick={() => handleCardClick("onTime")}>
                  <StatCard
                ...
                <div className="h-full" onClick={() => handleCardClick("reassigned")}>
                  <StatCard
                    label="Reassignments"
  ...
  <div className="text-center">
    {/* Icon */}
    <Users className="mx-auto h-12 w-12 text-gray-400 mb-4 animate-float-color" />

    {/* Heading */}
    <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2 animate-float-color">
      Select an Employee
    </h3>

    {/* Paragraph */}
    <p className="text-gray-600 dark:text-gray-400 animate-float-color">
...
const StatCard = ({ label, value, icon: Icon, color = "blue", subtitle }) => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}
      transition={{ delay: 0.1 }}
      className="liquid-glass-stats group cursor-pointer h-full min-h-[160px]"
    >
