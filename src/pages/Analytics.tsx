...
import { 
  TrendingUp,    // new icon for Total Tasks
  Check,         // new icon for Completed
  AlertTriangle, // new icon for Pending
  BarChart2,     // new icon for Overdue
  Activity, 
  Users, 
  CheckCircle, 
  Filter, 
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 items-stretch auto-rows-fr">
  {[
    {
      icon: TrendingUp,      // Replaced Activity → TrendingUp
      label: "Total Tasks",
    ...
    {
      icon: Check,           // Replaced CheckCircle → Check
      label: "Completed",
    ...
    {
      icon: AlertTriangle,   // Replaced AlertCircle → AlertTriangle
      label: "Pending",
    ...
    {
      icon: BarChart2,       // Replaced Activity → BarChart2
      label: "Overdue",
