      ...
      >
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            <h4 className="text-sm font-bold text-gray-900 dark:text-white leading-tight mb-1 break-words line-clamp-2">
              {task.title}
            </h4>
        ...
        {task.description && (
          <p className="text-xs text-gray-700 dark:text-gray-200 mb-3 line-clamp-2 break-words">
            {task.description}
          </p>
        )}
